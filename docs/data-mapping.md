...
- GET /Usage/usage/projectreads/monthly
...
| account_number         | Flipped Energy Account Number         | /MyAccount/ProjectAccountData    | accounts[0].accountNumber                                                                               | First non-empty text value.                                                                                                                                |
| meter_nmi              | Flipped Energy Meter NMI              | /Usage/usage/projectreads/daily  | first non-empty nmi value found in fetched usage rows                                                    | First non-empty text value from fetched usage rows.                                                                                                        |
...
| usage_weekly_kwh       | Flipped Energy Usage This Week        | /Usage/usage/projectreads/weekly  | rows where usageType=Export                                                                             | Sum abs(value) across Export rows; round to 6 decimals.                                                                                                    |
| usage_feedin_weekly_kwh | Flipped Energy Feed-In This Week     | /Usage/usage/projectreads/weekly  | rows where usageType=Import                                                                             | Sum abs(value) across Import rows; round to 6 decimals.                                                                                                    |
| usage_monthly_kwh      | Flipped Energy Usage This Month       | /Usage/usage/projectreads/monthly | rows where usageType=Export                                                                             | Sum abs(value) across Export rows; round to 6 decimals.                                                                                                    |
| usage_feedin_monthly_kwh | Flipped Energy Feed-In This Month   | /Usage/usage/projectreads/monthly | rows where usageType=Import                                                                             | Sum abs(value) across Import rows; round to 6 decimals.                                                                                                    |
...
| billing_period_start   | Flipped Energy Billing Period Start   | /Usage/usage/projectreads/daily, /MyAccount/ProjectAccountData | min/max daily usage row date; nextBillIssueDate fallback                                               | Prefer min usage row date from daily usage. Fallback to nextBillIssueDate (YYYY-MM-DD).                                                                    |
| billing_period_end     | Flipped Energy Billing Period End     | /Usage/usage/projectreads/daily, /MyAccount/ProjectAccountData | min/max daily usage row date; nextBillDueDate fallback                                                 | Prefer max usage row date from daily usage. Fallback to nextBillDueDate (YYYY-MM-DD).                                                                      |
