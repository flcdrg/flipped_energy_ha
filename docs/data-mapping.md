...
| usage_today_kwh        | Flipped Energy Usage Today            | /Usage/usage/projectreads/daily | rows where usageType=Import and date=time                                                               | Parse time to date; sum Import values for latest Import date in window.                                                                                    |
...
| last_successful_scrape | Flipped Energy Last Successful Scrape | Integration runtime             | Not from payload                                                                                        | Set to current UTC timestamp after successful snapshot build.                                                                                              |
...
The integration explicitly queries /Usage/usage/projectreads/daily with rolling UTC windows:
