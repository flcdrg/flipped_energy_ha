...
CONF_CURRENT_RATE_REFRESH_INTERVAL_MINUTES = "current_rate_refresh_interval_minutes"
...
DEFAULT_CURRENT_RATE_REFRESH_INTERVAL_MINUTES = 10
DEFAULT_INCLUDE_GST = True
MIN_REFRESH_INTERVAL_MINUTES = 5
MAX_REFRESH_INTERVAL_MINUTES = 180
MIN_CURRENT_RATE_REFRESH_INTERVAL_MINUTES = 5
MAX_CURRENT_RATE_REFRESH_INTERVAL_MINUTES = 60

SNAPSHOT_PLAN_NAME = "plan_name"
SNAPSHOT_ACCOUNT_NUMBER = "account_number"
SNAPSHOT_METER_NMI = "meter_nmi"
...
SNAPSHOT_USAGE_WEEKLY_KWH = "usage_weekly_kwh"
SNAPSHOT_USAGE_FEEDIN_WEEKLY_KWH = "usage_feedin_weekly_kwh"
SNAPSHOT_USAGE_MONTHLY_KWH = "usage_monthly_kwh"
SNAPSHOT_USAGE_FEEDIN_MONTHLY_KWH = "usage_feedin_monthly_kwh"
